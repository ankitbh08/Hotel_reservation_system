...
<div class="line" style="margin-top:20px;"><img src="line.jpg" width=250px;height=240px;></div> -->
<div class="Home" style="margin-top:60px;margin-left:30px; font-size:20px;margin-bottom:30px;"><a href="Cancellation.jsp" style="">Cancel Your Booking</a></div>
</div>
</div>
...
<th><div>
   ...
   Check in Date:<br>
<input class="form-control" data-required="true" id="check_date" maxlength="20" name="check_date" type="date" placeholder="Enter Date of Birth:" onchange="Check_In_Date()" required>
...
<th><div>
   ...
   Check out Date:<br>
   <input type="date" name="checkout_date" id="check_out_date" onchange="Check_Out_Date()" required>

</div></th>

<th><div>
   Room Type:<br>
  <input list="browsere" name="room_type" required>
...
<th><div>
   Rooms:<br>
  <input list="browserss" name="no_of_rooms" required>
...
<th><div style="margin-top:-20px;"><br>
   Adults:<br>
  <input list="browserse" name="no_of_adults" required>
...
<th><div style="margin-top:-20px;"><br>
   Children:<br>
  <input list="browsersee" name="no_of_children" required>
