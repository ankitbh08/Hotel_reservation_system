...
String total_price="";
	   ...
	   total_price=session.getAttribute("price").toString();
	   String booking_id="";
...
%>
 <div style="margin-left:500px;"><span style="color:#f4ce42;"><b><%=session.getAttribute("customer_name") %></b></span></div>
	    ...
	    <div style="text-align:center; margin-top:150px;"><span style="color:white; font-size:22px;"><b>booking_id:<%=booking_id %><br>Total Price:<%=total_price %></b></span><!-- <br>total_price:<%=total_price %> -->
	   
	   <form action="Payment Page.jsp"><button name="submit" type="submit" class="login__submit">Proceed To Pay</button></form>
